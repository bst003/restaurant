...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#content {\n  padding: 20px;\n  background-color: #000;\n}", "",{"version":3,"sources":["webpack://./src/assets/scss/styles.scss"],"names":[],"mappings":"AAEA;EACI,aAAA;EACA,sBAJI;AAGR","sourcesContent":["$black: #000;\n\n#content{\n    padding: 20px;\n    background-color: $black;\n}"],"sourceRoot":""}]);
// Exports
